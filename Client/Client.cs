...
public class Client
{
    ...
    private static readonly BigInteger P = BigInteger.Parse("", System.Globalization.NumberStyles.HexNumber);
    ...
    private static byte[] PackMessage(byte[] hmacTag, byte[] iv, byte[] ciphertext) { var package = new byte[32 + 16 + ciphertext.Length]; Buffer.BlockCopy(hmacTag, 0, package, 0, 32); Buffer.BlockCopy(iv, 0, package, 32, 16); Buffer.BlockCopy(ciphertext, 0, package, 48, ciphertext.Length); return package; }
    ...
    private static byte[] EncryptMessage(string message, byte[] key, out byte[] iv) { using var aes = Aes.Create(); aes.Key = key; aes.Mode = CipherMode.CBC; aes.Padding = PaddingMode.PKCS7; aes.GenerateIV(); iv = aes.IV; using var encryptor = aes.CreateEncryptor(); return encryptor.TransformFinalBlock(Encoding.UTF8.GetBytes(message), 0, message.Length); }
